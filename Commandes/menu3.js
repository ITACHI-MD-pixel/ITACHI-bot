...
╚════--------------- \n\n`;
    ...
    var link = "https://telegra.ph/file/d72a4c7f62821f1e72540.jpg";
    try {
        zk.sendMessage(dest, { image: { url: link }, caption: menuMsg, footer: "©ITACHI INC" }, { quoted: ms });
    }
    catch (e) {
